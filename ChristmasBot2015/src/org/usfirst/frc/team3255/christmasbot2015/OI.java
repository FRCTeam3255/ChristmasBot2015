...
import org.usfirst.frc.team3255.christmasbot2015.commands.*;
...
public class OI {
	...
	public OI()	{
		// driverStick
		D1.whenPressed(new ShooterSpeedMedium());
		D2.whenPressed(new ShooterSpeedLow());
		D3.whenPressed(new ShooterStop());
		D4.whenPressed(new ShooterSpeedHigh());
		D7.whileHeld(new CollectorPickUp());
		D8.whileHeld(new HopperLoad());
